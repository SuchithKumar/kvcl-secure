...
import org.vasaviyuvajanasangha.kvcl.service.SuccessHandler;
...
//                		.dispatcherTypeMatchers(DispatcherType.FORWARD).permitAll()
                        ...
                        .requestMatchers("/images/**", "/css/**", "/js/**", "/WEB-INF/jsp/**", "/favicon.ico","/chatgpt").permitAll()
                        .requestMatchers("/register-user", "/home", "/").permitAll()
